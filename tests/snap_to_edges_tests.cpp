...
TEST_CASE("SnapRectToEdges snaps left when within threshold", "[snap_to_edges]") {
...
TEST_CASE("SnapRectToEdges snaps right when within threshold", "[snap_to_edges]") {
...
TEST_CASE("SnapRectToEdges does not snap when beyond threshold", "[snap_to_edges]") {
...
TEST_CASE("SnapRectToEdges snaps to closest of multiple lines", "[snap_to_edges]") {
...
TEST_CASE("SnapRectToEdges does not snap left if would invert rect",
    ...
    RectPx out2 = SnapRectToEdges(narrow, vertical_narrow, horizontal, kThreshold);
...
TEST_CASE("SnapRectToEdges preserves minimum size 1x1 after snap", "[snap_to_edges]") {
