...
TEST_CASE("RectPxFromVirtualScreenMetrics — positive origin and size", "[virtual_screen][rect]")
{
...
TEST_CASE("RectPxFromVirtualScreenMetrics — negative origin (multi-monitor)", "[virtual_screen][rect]")
{
...
TEST_CASE("RectPxFromVirtualScreenMetrics — equivalence to MakeRectPx", "[virtual_screen][rect]")
{
...
TEST_CASE("RectPxFromVirtualScreenMetrics — normalized invariant (non-empty)", "[virtual_screen][rect]")
{
        RectPx r = RectPxFromVirtualScreenMetrics(0, 0, 1920, 1080);
...
TEST_CASE("RectPxFromVirtualScreenMetrics — normalized invariant (negative origin)", "[virtual_screen][rect]")
{
        RectPx r = RectPxFromVirtualScreenMetrics(-1920, 0, 1920, 1080);
        REQUIRE(r.left <= r.right);
        REQUIRE(r.top <= r.bottom);
